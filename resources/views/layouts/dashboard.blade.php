...
<body class="hold-transition sidebar-mini">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        ...
                        <li class="nav-item">
                            <a href="" class="nav-link">
                                <i class="nav-icon fas fa-users active"></i>
                                <p>Members</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a  class="nav-link">
                            <i class="nav-icon fas fa-hand-holding active"></i>
                            <p>Borrowings</p>
                        </a>
                    </li>
    ...
    <script>
        ...
        // Map custom data-widget to AdminLTE's expected value at runtime
        document.querySelectorAll('[data-widget="push-menu"]').forEach(function(el) {
            el.setAttribute('data-widget', 'pushmenu');
        });
    </script>
